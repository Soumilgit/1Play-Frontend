  ...
  return (
    <header
      className={cn(
        ...
        scrolled ? "bg-black/80 backdrop-blur-md border-b border-slate-800" : "bg-transparent",
      )}
    >
  ...
  <span className="font-bold text-xl tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-cyan-500">
    1Play Global
        ...
        <nav className="hidden md:flex items-center space-x-1">
          ...
          <Link href="/contact">
            <Button className="ml-2 bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-700 hover:to-cyan-700">
              Request Demo
            </Button>
          </Link>
        </nav>
          ...
          >
            <div className="container mx-auto px-4 py-3">
              <nav className="flex flex-col space-y-2">
                ...
                <Link href="/contact">
                  <Button className="mt-2 w-full bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-700 hover:to-cyan-700">
                    Request Demo
                  </Button>
                </Link>
              </nav>
