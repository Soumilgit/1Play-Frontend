      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <motion.h2
            ...
            transition={{ duration: 0.5 }}
            className="text-3xl md:text-4xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-cyan-400 dark:text-white"
          >
            Industries We Serve
          </motion.h2>
          <motion.div
        ...
        <div className="text-center mt-12">
          <Link href="/industries">
            <Button
              size="lg"
              className="bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-700 hover:to-cyan-700 dark:bg-gradient-to-r dark:from-purple-500 dark:to-cyan-500"
            >
