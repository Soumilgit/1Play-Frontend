                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                    {brandAssets.map((asset) => (
                      <div key={asset.id} className="text-center">
                        <div className="bg-slate-800 rounded-md overflow-hidden mb-2 aspect-square relative">
                          <Image
                        ...
                        <h4 className="text-sm font-medium mb-1">{asset.title}</h4>
                        <p className="text-xs text-slate-100">{asset.formats.join(", ")}</p>
                      </div>
                    ))}
                  </div>
                </CardContent>
