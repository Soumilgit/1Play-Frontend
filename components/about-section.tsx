      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <motion.h2
            ...
            className="text-3xl md:text-4xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-cyan-400"
          >
            About 1Play Global
          </motion.h2>
          <motion.div
...
Passionate professionals dedicated to innovation</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-slate-700 dark:text-slate-300 mb-6">
              ...
              We're committed to pushing the boundaries of what's possible in media production, streaming, and content
              management. Our team of engineers and industry experts work tirelessly to develop solutions that address
              the evolving needs of the media landscape.
            </p>
            <Link href="/about-us">
